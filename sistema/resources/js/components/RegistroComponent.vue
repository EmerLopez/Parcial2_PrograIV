                ...
                <div class="card text-bg-dark">
                    ...
                    <div class="catd-body">
                        ...
                        <div class="row p-1">
                            ...
                            <div class="col col-md-5">
                                <input v-model="registro.telefono" type="text" class="form-control" @input="formatoTelefono" maxlength="9" pattern="[0-9]*">
                            </div>
                        </div>
                        <div class="row p-1">
        ...
        methods:{
            buscarRegistro(e){
             ...
             formatoTelefono(event) {
                this.registro.telefono = this.registro.telefono.replace(/-/g, '');

                // Aplicar formato de teléfono (agregar guión después de cada 4 caracteres)
                this.registro.telefono = this.registro.telefono.replace(/\D/g, '').replace(/(\d{4})(?=\d)/g, '$1-');
        },
        numeros(event) {
                this.registro.telefono = this.registro.telefono.replace(/-/g, '');
            ...
            async guardarRegistro(){
                ...
                if (this.registro.nombre.trim() === '' || this.registro.apellido.trim() === '' 
                || this.registro.edad.trim() === '' || this.registro.telefono.trim() === ''
                || this.registro.correo.trim() === '' || this.registro.password.trim() === '')  {
